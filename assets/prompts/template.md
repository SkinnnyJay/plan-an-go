...
When generating via the planner script or skills, include at the top a metadata block inside HTML comments (scripts add it automatically; skills should emit it) so previews do not render it:
